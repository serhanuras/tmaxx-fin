...
class TmaxxFinRestApplicationTests {
  ...
  @Autowired private IAccountingPlanService accountingPlanService;
  ...
  void insertAccountingPlan() throws Exception {
    ...
    AccountingPlan insertAccountingPlan =
        accountingPlanService.insertAccountingPlan(accountingPlan);
