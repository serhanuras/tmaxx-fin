...
public class RestExceptionHandler {
  ...
  public ResponseEntity<Object> handleConflict(BadRequestException ex, WebRequest request) {
    Timestamp timestamp = new Timestamp(System.currentTimeMillis());
    ApiError apiError =
        new ApiError(
  ...
  public ResponseEntity<Object> handleAppException(BadRequestException ex, WebRequest request) {
    Timestamp timestamp = new Timestamp(System.currentTimeMillis());
    ApiError apiError =
        new ApiError(
  ...
  public ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    ApiError errorDetails =
        new ApiError(
            HttpStatus.BAD_REQUEST.value(), messages, timestamp, "ARGUMENT_VALIDATION_ERROR");
