...
public class AccountingPlanController {
  ...
  public AccountingPlanController(IAccountingPlanService accountingPlanService) {
  ...
  public List<AccountingPlanDto> getAccountingPlanByFirmId(
  ...
  @PostMapping()
  @ResponseStatus(HttpStatus.OK)
  public AccountingPlan insertAccountingPlan(
      @Valid @RequestBody AccountingPlanDto accountingPlanDto) {

    return accountingPlanService.insertAccountingPlan(
  ...
  @PutMapping()
  @ResponseStatus(HttpStatus.OK)
  public AccountingPlan updateAccountingPlan(
      @RequestBody @Valid AccountingPlanDto accountingPlanDto) {

    return accountingPlanService.updateAccountingPlan(
        AccountingPlanMapper.INSTANCE.toAccountingPlan(accountingPlanDto));
  }
